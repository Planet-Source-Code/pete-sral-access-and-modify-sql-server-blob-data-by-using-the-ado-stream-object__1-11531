...
if (ToolBar_Supported != null && ToolBar_Supported == true)
{
	...
	//Custom Support
	addICPMenu("CustomMenu", "Custom Support","Comprehensive support customized by customer type","/isapi/gosupport.asp?target=/directory/getitem.asp?item=CS&SD=GN");
	...
	//Worldwide Support
	addICPMenu("WWMenu","Worldwide Support","Support by worldwide location","/isapi/gosupport.asp?target=/directory/ww.asp?SD=GN");
	addICPSubMenu("WWMenu","Worldwide Support","/isapi/gosupport.asp?target=/directory/ww.asp?sd=GN");
	
	//Send us Your Feedback
	//addICPMenu("FeedbackMenu","Send us your feedback","Send us your feedback","/isapi/gosupport.asp?target=/directory/feedback/default.asp?SD=GN");
}
